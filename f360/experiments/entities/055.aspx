...
<script runat="server">
    ...
    protected void loginBtn_Click(object sender, EventArgs e)
    {
        ...
        {
            Guid guid = UserDAO.createGuid();
            message.Text = "Guid: " + guid;
        }
    }

    // @new
    protected void validateGuidBtn_Click(object sender, EventArgs e)
    {
        var guid = new Guid(guidTbx.Text);
        
        // @new
        bool valid = UserDAO.validateGuid(guid);
        
        if (valid)
        {
            message.Text = "Guid Valid";
        }
        else
        {
            message.Text = "Guid Not Valid";
        }
    }
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <!-- @new -->
                <asp:TextBox ID="guidTbx" runat="server" CssClass="form-control" placeholder="guid"/>
                <asp:Button ID="validateGuidBtn" runat="server" CssClass="btn btn-primary btn-block" Text="Register User" OnClick="validateGuidBtn_Click"/>
