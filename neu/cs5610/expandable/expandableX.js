...
/*
    ...
    This version differs from expandable.js in that
    the user must decide when to call loadExpandable.
    
    This permits the call to be deferred until other
    dynamic Javascript activities have taken place.
*/
