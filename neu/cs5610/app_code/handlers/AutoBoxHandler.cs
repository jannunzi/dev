...
namespace edu.neu.ccis.rasala
{
    ...
    /// compatibility.
    /// </summary>
    public class AutoBoxHandler : IHttpHandler
    {

        public void ProcessRequest(HttpContext context)
        {
            // File path has the form: .../AutoBox_w_h_r_g_b_a.aspx
            //
            ...
            */
            ...
            graphics.FillRectangle(new SolidBrush(color), 0, 0, w, h);
