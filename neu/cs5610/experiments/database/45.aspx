    ...
    <div class="container">
        ...
        <p>
            <asp:DetailsView
                ...
                ID="DetailsView1"
                runat="server"
                AutoGenerateRows="False" CommandRowStyle-CssClass="btn btn-primary" FooterStyle-CssClass="btn btn-primary"  DataKeyNames="Id" DataSourceID="SqlDataSource1" Height="50px" Width="125px" AllowPaging="True">
                <Fields>
