...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <h2>Add Image URL Form Submit</h2>

                <!-- @new -->
                <asp:TextBox ID="url" runat="server" CssClass="form-control"></asp:TextBox>
                <asp:Button ID="Button1" runat="server" Text="Add Image URL" CssClass="btn btn-primary" onclick="InsertShipper" />
                ...
                <p>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:wamConnectionString1 %>"
                        ...
                        <InsertParameters>
                            <asp:FormParameter Name="url" Type="String" FormField="url" />
                        </InsertParameters>
                        <UpdateParameters>
