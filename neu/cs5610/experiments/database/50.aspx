<%@ Page Language="C#" AutoEventWireup="true" CodeFile="50.aspx.cs" Inherits="experiments_database_00" %>
        ...
        <p>
            <asp:DetailsView CssClass="table" ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" Height="50px" Width="125px" AllowPaging="True">
                <Fields>
                    ...
                    <asp:CommandField ControlStyle-CssClass="btn btn-primary" ShowInsertButton="True" >
<ControlStyle CssClass="btn btn-primary"></ControlStyle>
        ...
        <h2>Source</h2>
       	<a target="_blank" href="../../fileview/Default.aspx?~/experiments/database/50.aspx">ASPX</a><br/>
        <a target="_blank" href="../../fileview/Default.aspx?~/experiments/database/50.aspx.cs">C#</a>
