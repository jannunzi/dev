...
<body>
    ...
    <div class="container">
        ...
        <h1>Factored out updateDatabase functionality</h1>
    ...
    <script>
        $(function () {
            ...
            // @new replaced stop event handlers so they use same function
            $(".box").draggable({
                stop: updateDatabase
            });
            $(".box").resizable({
            ...
            // @new factored out the stop event handlers into a single update function
