...
<head runat="server">
    ...
    <!-- @new added jquery theme for resizable to work -->
...
<body>
    ...
    <script>
        $(function () {
            ...
            // @new added resizable, note it's same code as for draggable
            $(".box").resizable({
                stop: function (event, ui) {
