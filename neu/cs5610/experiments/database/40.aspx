<%@ Page Language="C#" AutoEventWireup="true" CodeFile="40.aspx.cs" Inherits="experiments_database_00" %>
...
<body>
    ...
    <div class="container">
        ...
        <h2>Source</h2>
       	<a target="_blank" href="../../fileview/Default.aspx?~/experiments/database/40.aspx">ASPX</a><br/>
        <a target="_blank" href="../../fileview/Default.aspx?~/experiments/database/40.aspx.cs">C#</a>
