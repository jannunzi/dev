<%@ Page Language="C#" AutoEventWireup="true" CodeFile="55.aspx.cs" Inherits="experiments_database_00" %>
...
<body>
    ...
    <div class="container">
        ...
        <h2>Source</h2>
       	<a target="_blank" href="../../fileview/Default.aspx?~/experiments/database/55.aspx">ASPX</a><br/>
        <a target="_blank" href="../../fileview/Default.aspx?~/experiments/database/55.aspx.cs">C#</a>
