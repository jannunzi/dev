<%@ Page Language="C#" AutoEventWireup="true" CodeFile="07.aspx.cs" Inherits="experiments_bootstrap_00" %>
    ...
    <div class="main container">
        ...
        <div class="row">
          <div class="col-sm-8">
              ...
              For instance this column has column class .col-sm-8 and the column
              immediately to the right of this column has class .col-sm-4.
          </div>
          <div class="col-sm-4">
              <h3>Columns</h3>
              The 8 and 4 add up to 12. This column has column class .col-sm-4.
        ...
        <div class="row">
          <div class="col-sm-4">
              <h3>Three Columns</h3>
              These three columns are using class .col-sm-4, so that 4 x 3 columns = 12.
