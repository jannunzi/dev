<%@ Page Language="C#" AutoEventWireup="true" CodeFile="06.aspx.cs" Inherits="experiments_bootstrap_00" %>
...
<body>
    ...
    <div class="main container">
        ...
        <div class="row">
          <div class="col-md-4">
              <h3>Three Columns</h3>
              These three columns are using class .col-md-4, so that 4 x 3 columns = 12.
        ...
        <div class="row">
          <div class="col-md-6">
              <h3>Responsive</h3>
              These two columns have class .col-md-6 so they have the same
