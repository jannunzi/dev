<%@ Page Language="C#" AutoEventWireup="true" CodeFile="08.aspx.cs" Inherits="experiments_bootstrap_00" %>
...
<body>
    ...
    <div class="main container">
        ...
        <h1>Grid Systems (Extra Small)</h1>
        ...
        <div class="row">
          <div class="col-xs-8">
              ...
              For instance this column has column class .col-xs-8 and the column
              immediately to the right of this column has class .col-xs-4.
          </div>
          <div class="col-xs-4">
              <h3>Columns</h3>
              The 8 and 4 add up to 12. This column has column class .col-xs-4.
        ...
        <div class="row">
          <div class="col-xs-4">
              <h3>Three Columns</h3>
              These three columns are using class .col-xs-4, so that 4 x 3 columns = 12.
        ...
        <div class="row">
          <div class="col-xs-6">
              <h3>Responsive</h3>
              These two columns have class .col-xs-6 so they have the same
