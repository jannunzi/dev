...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-8">
                ...
                <h2>Render Trip Dropdown with Template</h2>
    ...
    <div class="wam-templates">
        <select class="wam-trips-template">
            <option class="nid title"></option>
        </select>
        <ul class="wam-fish-template">
            <li>(<span class="nid"></span>) <span class="title"></span> <span class="field_weight_lbs_value"></span> lbs <span class="field_temperature_value"></span> degrees</li>
        </ul>
    </div>
    ...
    <script>
        $(function () {
            ...
            jqCache.tripTemplate = $(".wam-trips-template option");
            ...
            function getFishEventHandler() {
                ...
                var template = jqCache.fishTemplate;
