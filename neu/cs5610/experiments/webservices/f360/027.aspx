...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-6 wam-spa-trip-list">
            ...
            <div class="col-xs-6 wam-spa-trip-details wam-hidden">
        ...
        <div class="row">
            <div class="col-xs-6 wam-hidden wam-spa-fish-list">
    ...
    <script>
        $(function () {
            ...
            function selectTripHandler() {
                ...
                $(".wam-spa-trip-details").show();
                $(".wam-spa-trip-list").hide();
            ...
            function getFishEventHandler() {
                ...
                $(".wam-spa-trip-details").hide();
                $(".wam-spa-fish-list").show();
