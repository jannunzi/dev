...
<form action="005.jsp" method="get">
...
try {
	...
	if("delete".equals(action)) {
		...
		newWidget = new Widget(name, content, top, left, width, height, bgColor, fgColor);
		...
		bgColor = request.getParameter("bgColor");
		fgColor = request.getParameter("fgColor");
		newWidget = new Widget(id, name, content, top, left, width, height, bgColor, fgColor);
		widgetBean.update(newWidget);
	}
	
	List<Widget> widgets = widgetBean.readList();
